...
<!doctype html> <html lang="en"> <head> <meta charset="UTF-8"> <title>Laravel and Angular Comment System</title>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="//api/components/bootstrap334dist/css/bootstrap.min.css"> <!-- load bootstrap via cdn -->
    <link rel="stylesheet" href="//api/components/bootstrap334dist/css/font-awesome.min.css"> <!-- load fontawesome -->
    <style>
    ...
    <!-- JS -->
    <script src="//api/components/jquery/jquery-1.11.3.min.js"></script>
    <script src="//api/components/angular1315/angular.min.js"></script> <!-- load angular -->
